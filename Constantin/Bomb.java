...
public class Bomb extends Projectile{
	...
	public Bomb(Vector position, Vector velocity, Actor owner, double friction, double elasticCoeficient){
		super(position, velocity, SIZE, SIZE, owner, friction, elasticCoeficient);
	}
	...
	public void update(Input input) {
		...
		if (time > timer){
			...
			getWorld().register(new Particle(getPosition(), radius, explosionDuration, "explosions/explosion.", 24));
