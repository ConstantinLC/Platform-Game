...
public class LevelTwo extends Level{
	...
	public void register(World world) {
		...
		world.register(new Block(new Box(new Vector(9, 3), new Vector(10, 5)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(-9, 3), new Vector(-8, 5)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(10, 5), new Vector(11, 7)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(-10, 5), new Vector(-9, 7)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(11, 7), new Vector(12, 14)), world.getLoader().getSprite("grass.center"), 7, "Y"));
		world.register(new Block(new Box(new Vector(-11, 7), new Vector(-10, 14)), world.getLoader().getSprite("grass.center"), 7, "Y"));
		world.register(new Block(new Box(new Vector(-10, 14), new Vector(-9, 16)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(10, 14), new Vector(11, 16)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(-9, 16), new Vector(-8, 18)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(9, 16), new Vector(10, 18	)), world.getLoader().getSprite("grass.center"), 2, "Y"));
		world.register(new Block(new Box(new Vector(8, 18), new Vector(9, 19)), world.getLoader().getSprite("grass.center"), 1, "X"));
		world.register(new Block(new Box(new Vector(-8, 18), new Vector(-7, 19)), world.getLoader().getSprite("grass.center"), 1, "X"));
		world.register(new Block(new Box(new Vector(-7, 19), new Vector(-5, 20)), world.getLoader().getSprite("grass.center"), 2, "X"));
		world.register(new Block(new Box(new Vector(6, 19), new Vector(8, 20)), world.getLoader().getSprite("grass.center"), 2, "X"));
		world.register(new Block(new Box(new Vector(-5, 20), new Vector(-3, 21)), world.getLoader().getSprite("grass.center"), 2, "X"));
		world.register(new Block(new Box(new Vector(4, 20), new Vector(6, 21)), world.getLoader().getSprite("grass.center"), 2, "X"));
		world.register(new Block(new Box(new Vector(-3, 21), new Vector(4, 22)), world.getLoader().getSprite("grass.center"), 7, "X"));
		...
		Boss boss = new Boss(new Vector(0.5, 10.5), 5, player, 26);
        world.register(boss);
        world.register(new Overlay(boss));
        ExistenceOf bossExistence = new ExistenceOf(boss.getClass());
        world.register(bossExistence);
        world.register(new Exit(new Vector(0,0.5), new LevelGG(), new Not(bossExistence)));
	}
